 ...
 * @author shadowfacts
 */
@Mod(modid = MOD_ID, name = NAME, version = VERSION, dependencies = "required-after:shadowmc@[3.4.8,);", acceptedMinecraftVersions = "[1.10.2]", guiFactory = "UUGUIFactory", modLanguageAdapter = "net.shadowfacts.forgelin.KotlinAdapter")
